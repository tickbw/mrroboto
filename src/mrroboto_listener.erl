...
-define(RESPONDERS, [
                     ...
                     {{'mrroboto_handlers', 'handle_route_req'}, [{<<"dialplan">>, <<"route_req">>}]}
                     ...
                     ,{{'mrroboto_handlers', 'handle_route_win'}, [{<<"dialplan">>, <<"route_win">>}]}
                    ]).
-define(QUEUE_NAME, <<>>).
